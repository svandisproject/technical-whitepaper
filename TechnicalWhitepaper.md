...
Companies will increasingly make their data more accessible to enhance their competitive position within the crypto space. We already see new models like DAICO emerging and the Svandis Platform must be adaptive to welcome those evolution. As the number of parameters involved in the buying of particular token also increases, the Svandis screeners flexible structured template will be adapted to reflect those continuous changes.
...
These events might not have an immediate effect on a company’s fundamentals, but short-term traders will be able to benefit from the analysis of these elements. This Svandis functionality will allow users to combine complementary data from multiple sources on a single chart, with the belief that the more flexible the UX, the better. Catalysts can be grouped and investigated to determine their impact later on in historical reviews. The Svandis Internal Team and Research Community together will be responsible for having online users confirming the occurrence of machine learning and algorithm detected events.
...
B2C framework will represent the case when Svandis partners or institutional clients (quant firms, analytical companies, research centres, exchanges and many other) would like to have a possibility of distribute their products and services to Svandis audience. Examples of such products are indicators, raw data, sentiments, research etc.

The advantages of B2C framework: institutional clients will benefit from having a new way to distribute their products to a new, broad and diverse audience of crypto-market traders and analysts; Svandis community and users will benefit from having more useful tool in their tool belts; Svandis ecosystem itself will benefit from having a reward from distribution, or by having more data in one place.

B2C distribution is possible only after check and approval by Svandis and it works on one of three basis:
Free distribution - works in case when a client is a well-known institution with a high quality product - Svandis ecosystem will mostly benefit from having such a partner and branding promotion;
...
The final phase will be delivering more control to the Research Community by transferring ownership of the Svandis Ecosystem smart contracts to a Decentralized Autonomous Organization (DAO) smart contract. In this manner, Svandis is dedicated to creating a decentralized solution that one day will be able to sustain its own growth and cultivation autonomously. Svandis Internal Team analysts will cease to contribute to the Research Community, and will at this time focus efforts on deeper insights demonstrated through research articles, marketplace offerings, and new development features.
